...
function practice_scripts() {
	...
	// here I am loading my custom css file - 'custom.css'
	wp_enqueue_style('practice-custom', get_template_directory_uri() . '/css/custom.css');


	wp_enqueue_script( 'practice-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'practice-accessibility', get_template_directory_uri() . '/js/accessibility.js' , array(), '',true );

	wp_enqueue_script( 'practice-accessibility', get_template_directory_uri() . '/js/stamps.js' , array(), '',false );
